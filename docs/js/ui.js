...
function updateScoreUI() {
  ...
  const parts = [];
  const opPart = opAvg == null ? null : opAvg * 0.80;
  const techPart = techAvg == null ? null : techAvg * 0.10;
  const intelPart = intelAvg == null ? null : intelAvg * 0.05;
  const medPart = medAvg == null ? null : medAvg * 0.05;
